...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 500, Height = 95 },
            Text = { X = 105, Y = 9.0, Scale = 1.15 },
        },
        Subtitle = {
            Background = { Width = 500, Height = 30 },
            Text = { X = 8, Y = 0.80, Scale = 0.35 },
            PreText = { X = 425, Y = 3, Scale = 0.35 },
        },
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 500 },
        Navigation = {
            Rectangle = { Width = 500, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu", Texture = "shop_arrows_upanddown", X = 220, Y = -3, Width = 40, Height = 40 },
        },
        Description = {
            Bar = { Y = 4, Width = 500, Height = 3 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 500, Height = 25 },
            Text = { X = 8.9, Y = 7, Scale = 0.30 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 500, Height = 275 },
            Grid = { Dictionary = "pause_menu_pages_char_mom_dad", Texture = "nose_grid", X = 115.5, Y = 47.5, Width = 200, Height = 200 },
            Circle = { Dictionary = "mpinventory", Texture = "in_world_circle", X = 115.5, Y = 47.5, Width = 20, Height = 20 },
            Text = {
                Top = { X = 240.5, Y = 15, Scale = 0.35 },
        ...
        Percentage = {
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 500, Height = 76 },
