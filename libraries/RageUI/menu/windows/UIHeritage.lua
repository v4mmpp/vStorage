...
---@type table
local Heritage = {
    Background = { Dictionary = "pause_menu_pages_char_mom_dad", Texture = "mumdadbg", Width = 500, Height = 180 },
    Mum = { Dictionary = "char_creator_portraits", X = 25, Width = 228, Height = 180 },
    Dad = { Dictionary = "char_creator_portraits", X = 195, Width = 228, Height = 180 },
}
