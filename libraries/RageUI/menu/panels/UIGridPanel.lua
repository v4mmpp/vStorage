...
local Grid = {
    ...
    Grid = { X = 120.5, Y = 47.5, Width = 250, Height = 201 },
    Circle = { Dictionary = "mpinventory", Texture = "in_world_circle", X = 115.5, Y = 47.5, Width = 20, Height = 20 },
    Text = {
        Top = { X = 240.5, Y = 15, Scale = 0.32 },
...
function RageUI.GridHorizontal(StartedX, TopText, RightText, Action, Index)
    UIGridPanel(GridType.Horizontal, StartedX, nil, TopText, nil, nil, RightText, Action, Index)
end
