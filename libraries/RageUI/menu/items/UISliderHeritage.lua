...
local SettingsSlider = {
    Background = { X = 310, Y = 14.5, Width = 150, Height = 9 },
    Slider = { X = 310, Y = 14.5, Width = 75, Height = 9 },
    Divider = { X = 383, Y = 9, Width = 2.5, Height = 20 },
    LeftArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_female_icon", X = 268, Y = 0, Width = 40, Height = 40 },
    RightArrow = { Dictionary = "mpleaderboard", Texture = "leaderboard_male_icon", X = 460, Y = 0, Width = 40, Height = 40 },
}
