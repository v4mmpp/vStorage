...
local SettingsSlider = {
    Background = { X = 330, Y = 14.5, Width = 150, Height = 9 },
    Slider = { X = 330, Y = 14.5, Width = 150, Height = 9 },
    LeftArrow = { Dictionary = "commonmenutu", Texture = "arrowleft", X = 505111, Y = 505111.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "commonmenutu", Texture = "arrowright", X = 505111, Y = 505111.5, Width = 15, Height = 15 },
}
